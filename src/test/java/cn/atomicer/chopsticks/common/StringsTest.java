...
public class StringsTest {
    ...
    public void testFullWidth() {
        ...
        Assert.assertEquals(true, Strings.existingFullWidthCharacters(str));

        Matcher matcher = Strings.getFullWidthCharacterMatcher(str);
    ...
    public void testReplaceFullWidthCharacters() {
        ...
        Assert.assertEquals(str_2, Strings.replaceAllFullWidthCharacters(str_1, ""));
    }
}
